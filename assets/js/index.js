...
_FRAMEWORK={
	...
	simple:()=>{
		$('.js-tab').click(function(){
			...
			$('.box-tab').addClass('display-n');
			$(target).removeClass('display-n');
		})
		$('.all_tour').click(function(){
	...
	clicktab:()=>{
		$('.js-tabm').click(function(){
			$('.js-tabm').removeClass('show');
			$(this).addClass('show');
			let target = $(this).data('target');
			$('.box-tabm').addClass('display-n');
			$(target).removeClass('display-n');
		})
		$('.all_tourm').click(function(){
			$('#list_nonem').removeClass('d-none');
		})
	...
	owlSlider: () => {
		...
		if (exists('#owl-tour_list_c1')) {
			$('#owl-tour_list_c1').owlCarousel({
				items: 3,
				slideSpeed: 1500,
				autoplayHoverPause: true,
				margin: 5,
		...
		if (exists('#owl-tour_list_c1m')) {
			$('#owl-tour_list_c1m').owlCarousel({
				items: 3,
				slideSpeed: 1500,
				autoplayHoverPause: true,
				margin: 5,
...
//////////TOUR C1
		var owlFeedBack = $('.owl-carousel.tour_c1');
