    ...
    <div class="maxSlider">
        ...
        <div class="box-slider">
            ...
            <div class="slider-left1">
                ...
                <div id="jssor_1"
                    style="position:relative;margin:0 auto;top:0px;left:0px;width:1440px;height:665px;overflow:hidden;visibility:hidden;">

                    <div data-u="slides"
                        style="cursor:default;position:relative;top:0px;left:0px;width:1440px;height:665px;overflow:hidden;">

                        <?php foreach ($slider as $k => $v){ $stt++; ?>

                        <div data-idle="3000">

                            <img width="1440" height="665" class="ratio-img__content img-scale" data-u="image"
