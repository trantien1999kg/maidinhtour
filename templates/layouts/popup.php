<?php 
    ...
    $popup =$db->rawQueryOne("select link , photo_$lang as photo from #_bannerqc where type=? and hienthi=1 limit 0,1",array('popup'));
 	...
 	<div class="home-popup__background">
 		...
 		<div class="home-popup__content">
 			...
 			<div class="simple-banner">
 				...
 				<img class="banner-image" src="<?=_upload_hinhanh_l.$popup['photo']?>" alt="popup">
