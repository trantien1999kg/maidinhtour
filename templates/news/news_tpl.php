    ...
    <div class="grid wide">
        ...
        <div class="row">
            ...
            <div class="col l-12 m-12 c-12">
                ...
                <div class="h__box__subject p-relative pb70 pb35m">
                        ...
                        <div class='col l-6 m-6 c-12 mb20 mb-m-10'>
                            ...
                            <div class="box-post">
                                ...
                                <div class="row">
                                    ...
                                    <div class='col l-12 m-6 c-5'>

                                        <a class='post-img ratio-img' href="<?=$v["type"]?>/<?=$v["tenkhongdau"]?>" title="<?=$v["ten_$lang"]?>" img-width="399" img-height="322">
                                            
                                            <span><i class="fa fa-file-text"></i></span>

                                            <img class="ratio-img__content img-scale pd5" src="./assets/images/loading_image.svg" data-src='<?=_upload_baiviet_l.$v["photo"]?>'
                            ...
                            <div class="box-post">
                                ...
                                <div class="row">
                                    ...
                                    <div class='col l-12 m-6 c-5'>
                                        ...
                                        <a class='post-img ratio-img' href="<?=$v["type"]?>/<?=$v["tenkhongdau"]?>" title="<?=$v["ten_$lang"]?>" img-width="300.46" img-height="422.14">
