<nav class="sidebar-nav">
    ...
    <ul class="metismenu" id="menu1">
        ...
        <li class="<?=($com=='baiviet' && ($_GET['type']=='icon')) ? "active" :""?>">
            <a class="has-arrow" href="#"
                aria-expanded=" <?=($com=='baiviet' && ($_GET['type']=='icon')) ? "true" :"false"?>">
                <span>
                    <i class="nav-icon text-sm fal fa-boxes"></i>Quản lý Dịch vụ con
                </span>

            </a>

            <ul aria-expanded="<?=($com=='baiviet' && ($_GET['type']=='icon')) ? "true" :"false"?>"
                class="collapse <?=($com=='baiviet' && ($_GET['type']=='icon')) ? "in" :""?>"
                <?=($com=='baiviet' && ($_GET['type']=='icon')) ? "" :"style='height: 0px;'"?>>

                <li class="<?=($com=='baiviet' && $act=='man' && 'icon'==$_GET['type']) ? "this" :""?>">

                    <a href="index.php?com=baiviet&act=man&type=icon&page=1">Danh sách</a>
