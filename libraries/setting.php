<?php 
	...
	$GLOBAL['baiviet'][$nametype]['title_main'] = 'album ảnh';
	...
	$GLOBAL['baiviet'][$nametype]['title_main'] = 'Touris';
...
$GLOBAL['baiviet'][$nametype]['cat'] = true;
	...
	$nametype='intro-bottom';

	$GLOBAL['photo'][$nametype]['title_main'] = 'hình ảnh footer';
	...
	$GLOBAL['photo'][$nametype]['img-gallery'] = true;

	$GLOBAL['photo'][$nametype]['multi-gallery-arr']=array
	...
	$GLOBAL['bannerqc'][$nametype]['title_main'] = 'Background Tour và giới thiệu';

	$GLOBAL['bannerqc'][$nametype]['title'] = 'Quản lý Background Tour và giới thiệu';
	...
	$GLOBAL['bannerqc'][$nametype]['img_type']='.swf|.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF|.webp';
		...
		$GLOBAL['bannerqc'][$nametype]['title_main'] = 'Tiêu đề TOUR';
	
		$GLOBAL['bannerqc'][$nametype]['title'] = 'Quản lý Tiêu đề TOUR';
	
		$GLOBAL['bannerqc'][$nametype]['full'] = false;
	
		$GLOBAL['bannerqc'][$nametype]['img'] = true;
	
		$GLOBAL['bannerqc'][$nametype]['img-width'] = 137;
	
		$GLOBAL['bannerqc'][$nametype]['img-height'] = 412;
	...
	$GLOBAL['bannerqc'][$nametype]['title_main'] = 'Background đăng ký tư vấn';

	$GLOBAL['bannerqc'][$nametype]['title'] = 'Quản lý Background đăng ký tư vấn';
	...
	$GLOBAL['bannerqc'][$nametype]['title_main'] = 'Background Dịch Vụ Du Lịch';

	$GLOBAL['bannerqc'][$nametype]['title'] = 'Quản lý Background Dịch Vụ Du Lịch';
