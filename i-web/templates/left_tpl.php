<nav class="sidebar-nav">
    ...
    <ul class="metismenu" id="menu1">
        ...
        <li class="<?=($com=='baiviet' && ($_GET['type']=='tour')) ? "active" :""?>">
            <a class="has-arrow" href="#"
                aria-expanded=" <?=($com=='baiviet' && ($_GET['type']=='tour')) ? "true" :"false"?>">
                <span>
                    <i class="nav-icon text-sm fal fa-boxes"></i>Quản lý TOURS
                </span>

            </a>

            <ul aria-expanded="<?=($com=='baiviet' && ($_GET['type']=='tour')) ? "true" :"false"?>"
                class="collapse <?=($com=='baiviet' && ($_GET['type']=='tour')) ? "in" :""?>"
                <?=($com=='baiviet' && ($_GET['type']=='tour')) ? "" :"style='height: 0px;'"?>>

                <li class="<?=($com=='baiviet' && $act=='man_list' && 'tour'==$_GET['type']) ? "this" :""?>">

                    <a href="index.php?com=baiviet&act=man_list&tbl=list&type=tour&page=1">Danh mục cấp 1</a>

                </li>

                <li class="<?=($com=='baiviet' && $act=='man' && 'tour'==$_GET['type']) ? "this" :""?>">

                    <a href="index.php?com=baiviet&act=man&type=tour&page=1">Danh sách</a>
        ...
        <li class="<?=($com=='baiviet' && ($_GET['type']=='tai-sao')) ? "active" :""?>">
            <a class="has-arrow" href="#"
                ...
                <span>
                    <i class="nav-icon text-sm fal fa-boxes"></i>Quản lý 3 Icon 
                </span>
        ...
        <li class="<?=($com=='baiviet' && ($_GET['type']=='album')) ? "active" :""?>">
            <a class="has-arrow" href="#"
                aria-expanded=" <?=($com=='baiviet' && ($_GET['type']=='album')) ? "true" :"false"?>">
                <span>
                    <i class="nav-icon text-sm fal fa-boxes"></i>Quản lý Album 
                </span>

            </a>

            <ul aria-expanded="<?=($com=='baiviet' && ($_GET['type']=='album')) ? "true" :"false"?>"
                class="collapse <?=($com=='baiviet' && ($_GET['type']=='album')) ? "in" :""?>"
                <?=($com=='baiviet' && ($_GET['type']=='album')) ? "" :"style='height: 0px;'"?>>

                <li class="<?=($com=='baiviet' && $act=='man' && 'album'==$_GET['type']) ? "this" :""?>">

                    <a href="index.php?com=baiviet&act=man&type=album&page=1">Danh sách</a>
        ...
        <li <?=($com=='photo' || $com=='video') ? ' class="active"' : '' ?>>
            ...
            <ul aria-expanded="<?=($com=='photo' || $com=='video') ? 'true' : 'false' ?>"
                ...
                <li <?=($com=='photo' && $_GET['type']=='intro-top') ? ' class="this"' : '' ?>><a
                        href="index.php?com=photo&act=man&type=intro-top&page=1" title="">Thông số giới thiệu</a>

                </li>

                <li <?=($com=='photo' && $_GET['type']=='intro-bottom') ? ' class="this"' : '' ?>><a
                        href="index.php?com=photo&act=man&type=intro-bottom&page=1" title="">Hình ảnh footer</a>
